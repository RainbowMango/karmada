...
const (
	// PolicyPlacementAnnotation is the placement annotation of a policy's placement.
	// The policy could be PropagationPolicy or ClusterPropagationPolicy.
	PolicyPlacementAnnotation = "policy.karmada.io/placement"
)
