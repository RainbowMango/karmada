...
// GetComponentReplicas returns the resource requirements for multiple components from the given object.
func (e *DefaultInterpreter) GetComponentReplicas(_ *unstructured.Unstructured) ([]workv1alpha2.ComponentRequirements, error) {
