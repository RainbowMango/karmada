...
type schedulingQueueOptions struct {
	...
	// rateLimitingOptions is only used by rateLimitingSchedulingQueue.
	rateLimitingOptions ratelimiterflag.Options
}
...
// WithRateLimitingOptions sets rateLimitingOptions for SchedulingQueue.
func WithRateLimitingOptions(options ratelimiterflag.Options) Option {
	return func(o *schedulingQueueOptions) {
		o.rateLimitingOptions = options
	}
}
...
func NewSchedulingQueue(
	...
	// When "PriorityBasedScheduling" is not enabled, we will fall back to the rate limiter queue.
