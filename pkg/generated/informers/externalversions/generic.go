...
func (f *sharedInformerFactory) ForResource(resource schema.GroupVersionResource) (GenericInformer, error) {
	...
	case propagationstrategyv1alpha1.SchemeGroupVersion.WithResource("overrides"):
		return &genericInformer{resource: resource.GroupResource(), informer: f.Propagationstrategy().V1alpha1().Overrides().Informer()}, nil
